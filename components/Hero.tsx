      ...
      <Container>
        <div className="flex flex-col gap-4 items-center xl:flex-row">
          ...
          <div className="flex flex-col gap-4">
            <h1 className="text-3xl font-extrabold text-center text-orange-950 sm:text-4xl md:text-5xl lg:text-6xl">
              SoftRyzenNews
            </h1>
            ...
            <p className="text-xs text-center font-bold text-orange-950 md:text-sm lg:text-lg">
              ...
              that delivers reliable and cutting-edge information to its
              readers.
            </p>
          </div>
        </div>
